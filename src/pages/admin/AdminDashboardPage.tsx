...
export default function AdminDashboardPage() {
  ...
  return (
    <>
      <header className="admin-header admin-dashboard-page-header">
        <div className="admin-page-heading">
          <span className="admin-page-eyebrow">운영 현황</span>
          <h1>리뷰 매니저 대시보드</h1>
          <p>운영 현황을 실제 데이터 기준으로 확인합니다. 마지막 갱신: {formatDateTime(lastUpdatedAt)}</p>
        </div>
        <div className="admin-page-header-tools" aria-label="대시보드 화면 도구">
          <AdminScopeCard
            adminId={adminId}
