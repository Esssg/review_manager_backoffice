...
import { buildProductOverviewRows, sortProductOverviewRows } from "@/utils/productOverviewRows";
...
export const PRODUCT_EXPORT_COLUMNS = [
  ...
  { key: "products.product_link", label: "링크", source: "products", field: "product_link", type: "text" },
