...
export const ADMIN_GATEWAY_OPERATION = Object.freeze({
  ...
  REVIEW_RECEIVE_LIST_SORTED: "review_receive.list.sorted",
  ...
  REVIEW_RECEIVE_PRODUCT_REVIEWER_BULK: "review_receive.product_reviewer_bulk",
  REVIEW_RECEIVE_SUBMISSION_CREATE: "review_receive.submission.create",
  REVIEW_RECEIVE_PRODUCT_REVIEWER_BULK_V2: "review_receive.product_reviewer.bulk_v2",
  ...
  PRODUCT_OVERVIEW_LIST_SORTED: "product_overview.list.sorted",
